/**
 * Review HTML v5 — Team review (Task 1)
...
const V3 = path.join(REVIEW, 'v5')
const V3_PROD = path.join(V3, 'products')

const VERSION = {
  id: 'v5',
  task: 'Task 1 — Site Product Audit',
  title: 'Team review v5: titles, natural voice, bed size, image dedupe',
...
<footer>${esc(VERSION.id)} · ${esc(VERSION.task)} · <code>review/v5/</code></footer>
<script>
const ROWS = ${dataJson};
...
<meta charset="utf-8"/><meta name="viewport" content="width=device-width, initial-scale=1"/>
<meta http-equiv="refresh" content="0; url=v5/audit.html"/>
...
<p><b>Latest:</b> <a href="v5/audit.html">v5 — Team review</a></p>
...
console.log(JSON.stringify({ version: 'v5', stats, path: path.join(V3, 'audit.html') }, null, 2))
