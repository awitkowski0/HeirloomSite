/**
 * Review HTML v6 — Kits, mattress, bed size (Task 1)
...
const V3 = path.join(REVIEW, 'v6')
const V3_PROD = path.join(V3, 'products')

const VERSION = {
  id: 'v6',
  task: 'Task 1 — Site Product Audit',
  title: 'v6: mattress image, Kit titles, conversion wording, bed-size vs pricebooks',
...
function qaCopy(desc, meta, title) {
  ...
  ok('no-emdash', !d.includes('\u2014') && !d.includes('\u2013'), 'No em/en dashes in description')
...
<footer>${esc(VERSION.id)} · ${esc(VERSION.task)} · <code>review/v6/</code></footer>
<script>
const ROWS = ${dataJson};
...
<meta charset="utf-8"/><meta name="viewport" content="width=device-width, initial-scale=1"/>
<meta http-equiv="refresh" content="0; url=v6/audit.html"/>
...
<p><b>Latest:</b> <a href="v6/audit.html">v6 — Kits, mattress, bed size</a></p>
...
<div class="card">
  ...
  <p><a href="v6/audit.html">Open v6 audit.html</a></p>
</div>
<div class="card">
...
console.log(JSON.stringify({ version: 'v6', stats, path: path.join(V3, 'audit.html') }, null, 2))
