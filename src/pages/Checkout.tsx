        ...
        <div className="product-showcase" style={{ flex: 7 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '48px' }}>
            <section>
               ...
               <div>
                  <label htmlFor="email" className="label-caps text-on-surface-variant" style={{ display: 'block', marginBottom: '8px' }}>EMAIL ADDRESS <span style={{ color: 'var(--error, #ba1a1a)' }}>*</span></label>
            ...
            <section>
               ...
               <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
                 <div>
                    <label htmlFor="firstName" className="label-caps text-on-surface-variant" style={{ display: 'block', marginBottom: '8px' }}>FIRST NAME <span style={{ color: 'var(--error, #ba1a1a)' }}>*</span></label>
                  ...
                  <div>
                     <label htmlFor="lastName" className="label-caps text-on-surface-variant" style={{ display: 'block', marginBottom: '8px' }}>LAST NAME <span style={{ color: 'var(--error, #ba1a1a)' }}>*</span></label>
                 ...
                 <div style={{ gridColumn: 'span 2' }}>
                    <label htmlFor="address" className="label-caps text-on-surface-variant" style={{ display: 'block', marginBottom: '8px' }}>ADDRESS <span style={{ color: 'var(--error, #ba1a1a)' }}>*</span></label>
                 ...
                 <div>
                    <label htmlFor="city" className="label-caps text-on-surface-variant" style={{ display: 'block', marginBottom: '8px' }}>CITY <span style={{ color: 'var(--error, #ba1a1a)' }}>*</span></label>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                     <div>
                         <label htmlFor="state" className="label-caps text-on-surface-variant" style={{ display: 'block', marginBottom: '8px' }}>STATE <span style={{ color: 'var(--error, #ba1a1a)' }}>*</span></label>
                     ...
                     <div>
                         <label htmlFor="zip" className="label-caps text-on-surface-variant" style={{ display: 'block', marginBottom: '8px' }}>ZIP CODE <span style={{ color: 'var(--error, #ba1a1a)' }}>*</span></label>
