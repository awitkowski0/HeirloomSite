...
| Variable | Purpose |
| --- | --- |
| `NEXT_PUBLIC_SITE_URL` | Canonical origin for canonical tags, `sitemap.xml` and absolute `og:image` URLs. Defaults to `https://heirloomcribsandmore.com` in production and `http://localhost:3000` in local development. |
